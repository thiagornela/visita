...
public class FormularioDialog_Situacao {
    ...
    FormularioDialog_Situacao(Context context,
                               String titulo,
    ...
    private void tentaPreencherFormulario(View viewCriada) {
        if (situacao != null) {
            EditText campoPrincipal = getEditText(viewCriada, R.id.dialog_campoPrincipal, campoAlterado);
            campoPrincipal.setText(situacao.getSituacao());
            EditText campoUnidade = getEditText(viewCriada, R.id.dialog_Unidade, "Unidade");
            campoUnidade.setText(situacao.getUnidade());
        }
    }
    ...
    private void criaProduto(EditText campoPrincipal, EditText campoUnidade) {
        ...
        int id = preencheId();
        Situacao situacao = new Situacao(id, textoPrincipal, unidade);
        listener.quandoConfirmado(situacao);
    }
    ...
    public interface ConfirmacaoListener {
        void quandoConfirmado(Situacao situacao);
    }
}