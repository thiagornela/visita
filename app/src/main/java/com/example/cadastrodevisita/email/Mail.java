...
public class Mail extends javax.mail.Authenticator {
    ...
    public Mail() {
        ...
        _from = _user = "webmaster@bilboque.com.br"; // usuário e email do remetente
        _pass = "625Bil###"; // senha
        _subject = "Obrigado pela visita"; // assunto
        _body = "Aguardamos você aqui!"; // mensagem html
